...
<body>
<form id="DatosContacto" name="DatosContacto" method="post" action="guardarEdicionDatosContacto.php">
  ...
  <label for="curp">ID del Empleado</label>
    <div>
              ...
              <?php 
                    ...
                    $id = $_GET["ID"];
                    $sql = "SELECT * FROM datoscontacto WHERE ID=$id";
...
$consulta_mysql='select ID from datoscontacto where ID='.$id;
  ...
  <label for="curp">CURP del Empleado</label>
    ...
    <div class="col-lg-4 con-md-3 col-sm-3 col-xs-3">
      <label for="correoi">Correo Institucional</label>
        <div>
          <input type="text" name="correoi" value='<?php echo $registro["CorreoInstitucion"]; ?>' type="hidden" id="correoi" class="form-control" required>
        </div>
    </div>
    ...
    <div class="col-lg-4 con-md-3 col-sm-3 col-xs-3">  
      <label for="telefonocasa">Teléfono de Casa</label>
        <div>
          <input type="text" name="telefonocasa" value='<?php echo $registro["TelefonoCasa"]; ?>' type="hidden" id="telefonocasa" class="form-control" required>
        </div>
    </div>
    
   <div class="col-lg-4 con-md-3 col-sm-3 col-xs-3">    
      <label for="celular">Teléfono de Celular</label>
        <div>
          <input type="text" name="celular" value='<?php echo $registro["TelefonoCelular"]; ?>' type="hidden" id="celular" class="form-control" required>
        </div>
    </div>
