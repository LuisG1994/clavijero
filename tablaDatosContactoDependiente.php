<script>
function editar(ID){
  window.location="editarDatosContactoDependiente.php?ID="+ID;
}
function eliminar(ID){
        var mensaje = "ESTAS SEGURO QUE QUIERES ELIMINAR";
  if(confirm(mensaje)){
    window.location="eliminarDatosContactoDependiente.php?ID="+ID;
  }else{
...
<div id="paginacion">
  ...
  <span class="icon-arrow-right" aria-hidden="true"></span>
         ...
         <div class="container py-4">
            <h3>Datos de Contacto de los Dependientes</h3></br>
            <div class="row">
            <div class="container py-4">
    ...
    <table class='table-container table-responsive rounded table-hover border-warning order-table'>
      ...
      <th class="text-center ">ID</th>
			<th class="text-center ">CURP Dependiente</th>
...
<?php 
            ...
            $ejecutar_consulta = $conexion->query($sql);
              ...
              while ($reg = $ejecutar_consulta->fetch_assoc()) {
                ...
                echo "<td>".utf8_encode(utf8_decode($reg["Celular"]))."</td>";
...
<div class="container py-4">
<a class="btn btn-warning btn-lg" href="ReporDatosDependientes.php">Reporte PDF  <span class="icon-bars"></span></a>
</div>
</div>
</div>
 <br>
