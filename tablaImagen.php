<script>
function editar(ID){
  window.location="editarImagen.php?ID="+ID;
}
...
<html lang="en">
<head>
<title>Tabla Fotografía de los Empleados</title>
<meta charset="UTF-8">
...
<body>
<form id="Datosfoto" name="Datosfoto" >
...
<div id="paginacion">
  ...
  <a href="tablaImagen.php" aria-label="Previous">
  <span class="icon-arrow-right" aria-hidden="true"></span>
  </a>
</div>
         <div class="container py-4">
            <h3>Fotografía de los Empleados</h3></br>
            <div class="row">
              <div class="container py-4">
...
<?php 
            ...
            $sql = "SELECT imagen.ID, Empleado.CURPEmpleado,Empleado.Nombre,Empleado.ApPaterno, Empleado.ApMaterno, imagen.Imagen from imagen inner join Empleado ON imagen.CURPEmpleado = Empleado.CURPEmpleado;";
