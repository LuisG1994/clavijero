...
<body>
<form id="editarFoto" name="editarFoto" enctype="multipart/form-data" method="post" action="guardarEdicionFoto.php">
...
<div id="paginacion">
  ...
  <a href="editarImagen.php" aria-label="Previous">
...
<div class="container py-4">
            <h3>Actualización de foto del Empleado</h3>
            <div class="row">
...
$consulta_mysql='select ID from imagen where ID='.$id;
...
<div class="col-lg-4 con-md-3 col-sm-3 col-xs-3">
  <label for="curp">CURP del Empleado</label>
    ...
    <div class="col-lg-3 con-md-3 col-sm-3 col-xs-3">
        ...
        <div>
            <input type="file" id="imagen" name="imagen" class="form-control" accept="image/*" value='<?php echo $registro["Imagen"]; ?>'>
        </div>
    </div>
